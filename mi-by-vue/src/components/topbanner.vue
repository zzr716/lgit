	...
	<div class="top-banner clearfix">
		<div class="site-category"
			...
			<div class="top-side-left">
				<ul class="side-left">
					<li class="side-item" @mouseenter="evtSideEnter(item.type)"
						v-for="item in sideItems" v-bind:key="item">
						{{item.content}}
					</li>
				</ul>
			</div>
			<div class="site-category-detail"
				v-show="goodsStatus">
				<ul class="category-items" v-for="goods in filterCurrGoods" v-bind:key="goods">
					<li class="category-goods" v-for="item in goods" v-bind:key="item">
